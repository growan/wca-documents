...
- 5b) If a puzzle defect occurs during an attempt, the competitor may choose to either repair the defect and continue the attempt, or to stop the attempt.
    ...
    - 5b5) If some parts of the puzzle are physically detached or not fully placed at the end of the attempt, the puzzle is considered unsolved. Penalty: disqualification of the attempt (DNF).
...
- 10d) All pieces of a puzzle must be fully attached to the puzzle in their required positions.
- 10e) A puzzle is solved when all face colours are reassembled, and all parts are placed according to [Regulation 5b5](regulations:regulation:5b5) within the alignment limits in [Regulation 10f](regulations:regulation:10f). Penalty: disqualification of the attempt (DNF).
