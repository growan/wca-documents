...
- 3d4+) [EXAMPLE] Examples of permitted use of coloured plastic include: commonly known "stickerless" cubes with different plastic colour on each face.
- 3d4++) [EXAMPLE] Examples of forbidden use of coloured plastic include: puzzle with white plastic colour, but black plastic colour for "cross" pieces/"last layer" pieces, etc.
