...
- 1c) The WCA Delegate may delegate responsibilities to other members of the organisation team, but is *ultimately accountable* for how these responsibilities are carried out. The WCA Delegate for a competition is responsible for:
  ...
  - 1c3) Sending the competition results to the WCA Results Team.
    - 1c3a) All *scramble sequences['scrambles' is commonly used, I'll not highlight all cases on this]* used during a competition must be sent with the results of the competition.
    - 1c3b) Scramble sequences must be labelled with the events, rounds, and *heats[I believe everyone just calls it groups, I will not highlight 'heats' again]* for which they were used.
  ...
  - 1c9) Decisions about changes to the scheduled times of rounds. In cases of such changes, a *clear announcement must be made to all competitors[all competitors must be informed]*.
  - 1c10) Making a copy of the WCA Regulations available at the competition.
- 1e) Each event must have one or more judges.
  - 1e1) A judge is responsible for *executing the procedures[vague]* of the event.
...
- 1f) Each event must have one or more scramblers. Exception: puzzles that are not scrambled
  - 1f1) *A scrambler applies scramble sequences to prepare solved puzzles for attempts[A scrambler scrambles the puzzles to be solved by the competitors]* .
...
- 1g) Each event must have one or more score takers.
  ...
  - 1g2) Any change to the result on a score sheet must be made *probably forgot 'at'* *the discretion[I will not highlight 'at the discretion again]* of the WCA Delegate.
- 1h) Competitors in the same round of an event may be divided into heats.
  - 1h1) Scramblers for a round must not scramble *[previously you used 'apply scramble sequences' and now you changed to 'scramble' and 'scrambles', inconsistent, I suggest just 'scramble' in all cases]* for competitors in their own heat before they have finished all of their attempts for the round. Scramblers and judges must not see or judge any scrambles from their heat that they have not attempted yet.
  - 1h2) Competitors in the same heat must use the same scramble *sequences[back to the sequences I see ;-)]*. Different heats must use different scramble sequences.
...
- 2a) Any person may compete in a WCA competition if he:
  ...
  - 2a2) *Meets the competition requirements[vague]*, which must be clearly announced before the competition.
...
- 2c) Competitors shall register by providing all information required by the organisation team (including: name, country, date of birth, gender, contact information, selected events).
  - 2c1) A competitor shall not *be eligible[allowed? able?]* to compete without a completed registration, as determined by the organisation team.
- 2d) A competitor's name, country, gender, and competition results are considered public information. All other personal information is considered confidential, and must not be *disclosed* to outside organisations/persons without the *consent[permission]* of the competitor.
- 2e) Competitors must represent a country of which they hold citizenship. The WCA Delegate *should verify citizenship standing by means of* documents (e.g. a passport). If a competitor is found *ineligible[I will not highlight 'eligible', 'not eligible' or 'ineligible' again]* to represent the country under which they have registered, the competitor may be disqualified *retroactively* and/or suspended, at the discretion of the WCA Board.
...
- 2f) Competitors must *obey venue rules and conduct themselves in a considerate manner['obey', 'conduct', 'considerate manner' are too hard]*.
- 2g) Competitors must remain quiet when inside the designated competition area. Talking is *permitted[allowed? unless they don't mean exactly the same I don't see why to choose the harder word, I will not highlight 'permitted' again]*, but must be kept at a reasonable level, and away from competitors who are actively competing.
...
- 2j) The WCA Delegate may disqualify a competitor from a specific event.
  ...
  - 2j2) If a competitor is disqualified during the course of an event, his earlier results shall remain valid. Exception: cheating or *defrauding [I will not highlight defrauding again]* (see Regulation 2k2a).
...
- 2n) Competitors may *verbally dispute[I will not highlight 'verbal' or 'dispute' again]* a ruling to the WCA Delegate.
...
- 3d) Puzzles must have coloured stickers, coloured tiles, or painted/printed colours.
  - 3d1) Exception: Competitors with a medically documented visual disability may use textured puzzles with different textures on different faces. Textures/patterns must be *uniform['the same'? I will not highlight uniform again]* per face. Each face should have a distinct colours, to *aid[help?]* in scrambling and judging.
...
- 3j) Any modifications to a puzzle that result in poor performance by a competitor are not *grounds for* *additional attempts['extra attempts' is commonly used]*.
- 3k) Puzzles must be clean, and must not have any markings, elevated pieces, damage, or other differences that *distinguish[I wouldn't know what to use else though]* any piece from a similar piece.
...
- 5b) If a puzzle defect *occurs* during an attempt, the competitor may choose to repair the defect and continue the attempt, or to stop the attempt.
  ...
  - 5b4) During blindfolded events, a puzzle defect must be repaired during the attempt, and all repairs must be *performed[done]* blindfolded. Penalty: disqualification of the attempt (DNF).
...
- 5c) If a competitor has a puzzle defect, this does not give him the right to an *extra attempt[inconsistent, you used 'additional attempt before, I suggest 'extra attempt' as it is commonly used]*.
...
- 7f) Solving station:
  ...
  - 7f2) The timer must be attached to the mat and placed directly on the table, desk or other *suitable console*, with the timer on the side of the mat nearest to the competitor. The mat must be placed *flush against the surface* of the table.
    - 7f2a) Exception: For Solving With Feet, the timer must be placed directly on the floor. The timer *device[what does 'device' add to 'timer'?]* may be placed *on the side of the mat farthest from the competitor[on the opposite side]*.
...
- 8a) An official WCA competition must:
  ...
  - 8a7) Use the authentic Speed Stacks Stackmat timer (Generation 2 or Pro) for *time measurement[timing?]*.
...
- 8f) If WCA Regulations are not *correctly observed[vague]* during a competition, the WCA Board may disqualify affected attempts.
...
- 9f) The results of a round are measured as follows:*[overall hard to understand]*
  ...
  - 9f8) For "Average of 5" rounds, competitors are allotted 5 attempts. Of these 5 attempts, the best and worst attempts shall be removed, and the *arithmetic mean[probably no alternative]* of the remaining 3 attempts shall count for the competitor's ranking in the round.
  - 9f9) For "Average of 5" rounds, one DNF or DNS is permitted to count as the competitor's worst result of the round. If a competitor *receives[gets]* more than one DNF and/or DNS in the round, his average score for the round is DNF.
...
- 9o) *A Combined rounds and Qualification rounds[grammar]* each count as one round when counting the number of rounds per event.
...
- 9r) A qualification round must be held before the first round of the event.
  - 9r1) When announcing an event, the organisation team must include:
    ...
    - 9r1b) Any limit to the number of competitors permitted in the qualification round of the event, and any limit *tothe[missing space]* maximum number of those competitors who will proceed to the first round.
...
## Article 10: Solved State *[readability is irrelevant due to the clear images]*
...
## Article 12: Notation *[hard to explain in the first place, let alone in simple English. How about a link to Lucas' applet to show the moves?]*
...
- A1) Speed Solving attempts must abide by the following procedure.
  - A1a) The organisation team may enforce time limits for attempts and/or rounds.
    ...
    - A1a5) *An attempt shall be considered to meet the time limit if and only if the original recorded time, before any time penalties are applied, is strictly less than the time limit[seems a bit weird because of "if an only if" and "strictly less"]*. Exception: Multiple Blindfolded Solving (see Regulation H1b1).
  - A1b) If the time limit for an attempt is greater than 10 minutes, a stopwatch must be used for timekeeping.
    ...
    - A1b2) If the Stackmat time is available, it is the *original recorded time[counting time]*. Otherwise, the stopwatch time is the original recorded time.
...
- A2) Scrambling:
  ...
  - A2b) *A scrambler scrambles the puzzle[inconsistent, before you used 'a scrambler applies a scrambling sequence]* according to the regulations in Article 4.
...
- A3) Inspection:*[Maybe include a link here to a video that shows the whole procedure]*
  ...
  - A3b) Before the competitor starts the attempt, the judge shall reset the timer and, *where applicable[I suggest '...the timer and/or, the stopwatch.'*, the stopwatch.
  ...
  - A3c) The competitor may pick up the puzzle during inspection.
    ...
    - A3c3) The competitor may reset the timer before he starts the solve.*[this is not a readability note but a normal note, A3c3 is unnecessary since there is already A3b (unless you mean that it is 'allowed for the competitor to reset the timer when the judge forgot to do this'. In that case I suggest changing it.)]*
...
- A4) Starting the solve:
  - A4b) The competitor places his hands on the *elevated sensor unit* of the timer, with his fingers touching the sensors and palms down. Penalty: time penalty (+2 seconds).
    - A4b1) The competitor must *have no physical contact with[what is wrong with just 'touch'?]* the puzzle between the inspection period and the beginning of the solve. Penalty: time penalty (+2 seconds).
...
- A5) During the solve:
  ...
  - A5b) While inspecting or solving the puzzle, the competitor must not *receive assistance[get help]* from anyone or any object other than the surface. Penalty: disqualification of the attempt (DNF).
- A6) Stopping the solve:
  - A6a) The competitor stops the solve by releasing the puzzle and then stopping the timer.
    *- A6a1) If a stopwatch is in use as the timing device, the competitor ends the solve by releasing the puzzle and *notifying the judge that he has stopped the solve.[I think you can merge A6a1 and A6a2]*
  ...
  - A6b) The competitor is responsible for stopping the timer correctly.
    - A6b1) If the timer stops before the end of the solve and the timer shows a time *strictly[why strictly? what room is there to speculate with just 'below 0.06'?]* below 0.06 seconds, then the attempt shall be replaced by an extra attempt. A competitor *forfeits his right* to the additional attempt if the WCA Delegate determines that the timer was stopped deliberately.
  ...
  - A6e) The competitor must not *touch[insonsistent, before you used 'have physical contact with', I suggest 'touch']* or move the puzzle until the judge has inspected the puzzle. Penalty: disqualification of the attempt (DNF). Exception: If no moves have been applied, a time penalty (+2 seconds) may be assigned instead, at the discretion of the judge.
...
- B4) Blindfolded phase:
  - B4a) The competitor shall *don the blindfold[to be honest I didn't know it was called 'to don a blindfold' before reading the WCA regs]* after the memorisation phase.
...
- E2) Procedure for Fewest Moves Solving:
  ...
  - E2e) The competitor's solution must not be directly *derived* from any part of the scrambling algorithm. Penalty: disqualification of the attempt (DNF).
    - E2e1) The WCA Delegate may ask the competitor must to explain the purpose of each move in his solution, *irrespective* of *'the'* scrambling algorithm. The WCA Delegate shall determine the *validity* of the solution.
- E3) The competitor may use the following objects during the attempt. Penalty for using unauthorised objects: disqualification of the attempt (DNF).
  ...
  - E3b) 1-3 puzzles *corresponding to the event[why not just say Rubik's cubes? it's not like there are other puzzles we are FMC-ing]* (self-supplied).
